...
class ReferralSystem {
    ...
    async registerUser(telegramUser) {
        ...
        try {
            const response = await fetch('https://panda-scz8.onrender.com/api/user/register', {
                method: 'POST',
                headers: {
    ...
    async getUserData(username) {
        ...
        try {
            const response = await fetch(`https://panda-scz8.onrender.com/api/user/${username}`);
    ...
    async requestWithdrawal(username, amount, walletAddress) {
        ...
        try {
            const response = await fetch('https://panda-scz8.onrender.com/api/withdraw', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
